...
class ProfileController extends Controller
{
    ...
    public function profileStore(Request $request)
    {
        ...
        $profile = Profile::create([
            ...
            "redessociales" =>$request->redessociales, // Ensure this is updated correctly
            "precios" =>$request->precios, // Ensure this is updated correctly
        ]);
    ...
    public function profileUpdate(Request $request, $id)
    {
        ...
        return response()->json([
            "message" => 200,
            "profile" => $profile,
            // "profile" => PresupuestoResource::make($presupuesto),
        ]);
    }
